...
//#define LWIP_DEBUG 1
#define UDP_SERVER_IP "192.168.1.1"  // Change to your PC IP
#define UDP_SERVER_PORT 8888

// ERROR INDICATOR LED
#define ERROR_LED_PIN     LED_RED_Pin
#define ERROR_LED_PORT    LED_RED_GPIO_Port

// FAULT INDICATOR LED
#define FAULT_LED_PIN     LED_YELLOW_Pin
#define FAULT_LED_PORT    LED_YELLOW_GPIO_Port

// MICROROS AGENT CONNECTION STATUS
#define MICROROS_CONNECTED_LED_PIN     LED_GREEN_Pin
#define MICROROS_CONNECTED_LED_PORT    LED_GREEN_GPIO_Port
