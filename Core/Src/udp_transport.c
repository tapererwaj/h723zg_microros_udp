...
bool cubemx_transport_open(struct uxrCustomTransport * transport){
    ...
    {
    	HAL_GPIO_WritePin(MICROROS_CONNECTED_LED_PORT, MICROROS_CONNECTED_LED_PIN, GPIO_PIN_RESET);
        return false;
    }

    HAL_GPIO_WritePin(MICROROS_CONNECTED_LED_PORT, MICROROS_CONNECTED_LED_PIN, GPIO_PIN_SET);
    return true;
}
